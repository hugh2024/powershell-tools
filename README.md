...
| [LocalAdminAuditor](LocalAdminAuditor-GUI.ps1) | GUI local Administrators group auditor — AD domain scan, risk scoring, remote remediation, trend tracking |
---
...
- PowerShell 5.1+
- Run as Administrator (SecurityChecker, LocalAdminAuditor)
- RSAT / ActiveDirectory module (LocalAdminAuditor — auto-installs if missing)
- PowerShell Remoting enabled on targets (LocalAdminAuditor)
---
## License
